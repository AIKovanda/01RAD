...
\newcommand{\trace}{\mathrm{tr}} 						% stopa
\newcommand{\inv}[1]{{#1^{-1}}}
...
\newcommand{\nula}{\boldsymbol{0}}
\newcommand{\Identita}[1]{\textbf{I}_{#1}} % identita s indexem velikosti
% obecné matice A,B,H
\newcommand{\Am}{\textbf{A}} % matice A
...
% Fisherova matice
\newcommand{\fisher}{\textbf{I}} % Fisherova matice
...
% tučné X
\newcommand{\X}{\mathbf{X}} % klasické
\newcommand{\lX}{\overline{\mathbf{X}}} % s pruhem
% tučné Y
\newcommand{\Y}{\mathbf{Y}} % klasické
...
\newcommand{\hYi}{\widehat{Y}_i}
% vektorové
\newcommand{\hYb}{\widehat{\mathbf{Y}}}
\newcommand{\hyb}{\widehat{\mathbf{y}}}
% rezidua: e
\newcommand{\he}{\widehat{e}}
\newcommand{\heb}{\widehat{\mathbf{e}}}
% a nějaké další
\newcommand{\hsn}{\widehat{\sigma}_n\FF}				% sn se stříškou
...
\newcommand{\lYb}{\overline{\Y}}

% neroztříděno
\newcommand{\hx}{\overline{x}}
\newcommand{\hej}{\widehat{e}_j}
\newcommand{\Nn}{\mathcal{N}(0,\sigma^2\textbf{I})}
...
\newcommand{\norm}[1]{\| #1 \|}
\newcommand{\In}{\Identita{n}}
\newcommand{\Q}{\textbf{Q}}
\newcommand{\Tstat}{\mathrm{T}}
